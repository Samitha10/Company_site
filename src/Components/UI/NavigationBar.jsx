...
//                             </span>
//                         </a> */}
//                         <a id="Menu" class="navbar-burger mr-12 xl:hidden self-right" href="#">
//                             <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <nav className="flex justify-between bg-gray-900 backdrop-blur-sm text-white w-screen flex-wrap items-center opacity-100 top-0 bg-gray-4">
                <div className="px-5 xl:px-12 py-2 flex w-full items-center justify-between">
                    ...
                    <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                        <li><a className="hover:text-gray-1 text-gray-2 font-Poppins" href="#">Home</a></li>
                        <li><a className="hover:text-gray-1 text-gray-2 font-Poppins" href="#">Category</a></li>
                        <li><a className="hover:text-gray-1 text-gray-2 font-Poppins" href="#">Collections</a></li>
                        <li><a className="hover:text-gray-1 text-gray-2 font-Poppins" href="#">Contact Us</a></li>
                    </ul>
                    <div className="hidden xl:flex items-center space-x-5">
                        <a className="hover:text-gray-200 hover:text-gray-1 text-gray-2" href="#">
                            <BsLinkedin />
                    ...
                    <a id="Menu" className="xl:hidden self-right ml-0" href="#">
