          ...
          <div className="rounded-[25px] border-[5px] border-gray-4 bg-gray-6  block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/0 w-full max-w-sm h-[400px]">
            ...
            <div className="p-6">
              ...
              <p className="mt-4">
                ...
                Our company experienced remarkable growth after implementing the
                solutions provided by OctaForge.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className=" rounded-[25px] border-[5px] border-gray-4 bg-gray-6  block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30 w-full max-w-sm h-[400px]">
            ...
            <div className="p-6">
              ...
              <p className="mt-4">
                ...
                The innovative solutions provided by OctaForge revolutionized
                our workflow and significantly boosted our productivity.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-[25px] border-[5px] border-gray-4 bg-gray-6  block rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30 w-full max-w-sm h-[400px]">
            ...
            <div className="p-6">
              ...
              <p className="mt-4">
                ...
                OctaForge provided us with tailor-made solutions that perfectly
                aligned with our business needs. Highly recommended!
              </p>
            </div>
          </div>
        </div>
